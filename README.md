...
## Примечание
Для корректного создания независимой копии объекта была использована функция `copy.deepcopy()` из стандартной библиотеки Python. Это необходимо для того, чтобы изменение копии объекта не приводили к изменениям в оригинале.  
Источник: документация Python (https://docs.python.org/3/)